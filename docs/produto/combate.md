...
Bônus permanentes obtidos via Livraria são válidos apenas em PvE. O PvP (Guild War) não herda automaticamente essas vantagens de farm.
...
- Bônus permanentes de Livraria valem só em PvE; não se aplicam em Guild War.
...
| Escopo do bônus de Livraria | PvE-only | caminho previsto: `packages/content/livraria` |

O catálogo de magias e seus números de dano/custo/cooldown pertence a `progressao.md` — este arquivo cobre só a matemática geral de acerto/Dodge.
