...
- [`hud-contract-plan.md`](hud-contract-plan.md) — o plano do contrato do HUD (pós-M17, ADR 0032): o que a imagem do kit já tem no cliente e o que falta, região a região, e os marcos M18 (barra de ações, suprimento e automações), M21 (postura, moedas, loot e skills), M22 (topo e mundo) mais o que entra no M20. Instantâneo.
- [`hunt-bot-parity-plan.md`](hunt-bot-parity-plan.md) — o plano para o bot de hunt se mover, escolher alvo, atacar e seguir como o observado no Huntera (Parte IV da referência, 2026-09-22) e como o Tibia: alvo por membro seguido, A* orçado para follow/perseguição, distância com referência boss > monstro > knight — três fases, sem magia nova. Instantâneo.
...
- [`party-vip-plan.md`](party-vip-plan.md) — o desenho da Party v2 e Premium (M20): eixos mutáveis, bolsa com reserva e elegibilidade, entrada em curso, sala pública, Amigos, bot cooperativo; as decisões estão no ADR 0035. Instantâneo.
...
- [`local-dragon-party.md`](local-dragon-party.md) — o passo a passo local do M28: Docker, `.env`, migração, os três papéis e o cliente, `pnpm dev:dragon-party` para semear os quatro personagens level 200 e formar a party, e o que observar na Darashia Dragon Lair. Vivo.
- [`tibia-parity-plan.md`](tibia-parity-plan.md) — o plano de paridade do catálogo (M29–M44, pós-M28): o que cada marco entrega, o que fica fora e por quê, e as doze questões em aberto que os ADRs 0038–0046 ainda esperam do dono. Instantâneo.
