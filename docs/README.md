...
- [`hunt-bot-parity-plan.md`](hunt-bot-parity-plan.md) — o plano para o bot de hunt se comportar como o observado no Huntera (Parte IV da referência, 2026-09-22): alvo por membro seguido, distância com referência boss > monstro > knight, condições da barra, fight mode, catálogo e munição em área — sete fases, cada uma uma issue. Instantâneo.
