...
- [`party-vip-plan.md`](party-vip-plan.md) — o desenho da Party v2 e Premium (M20): eixos mutáveis, bolsa com reserva e elegibilidade, entrada em curso, sala pública, Amigos, bot cooperativo; as decisões estão no ADR 0033. Instantâneo.
