...
**A tabela `account` nasce também com `senha_hash`, nulável e sem uso.** É uma coluna sem custo
...
- Portabilidade de identidade fica limitada: provedores não exportam hash de senha. `senha_hash`
