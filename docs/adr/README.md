...
| [0025](0025-otclient-web-as-world-renderer.md) | OTClient em WebAssembly como renderizador do mundo | proposto | Teste, em branch e local: a engine do tibia-idle desenha o mundo por um segundo socket em Tibia 13.10; o shell React e o `/ws` ficam. 13.10, HUD em DOM, patches sobre commit fixado, Pixi sai. Vira `aceito` quando a Fase 2 do plano for observada na tela. |
