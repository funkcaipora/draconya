...
| [0023](0023-the-city-is-a-shard.md) | A Cidade é um shard | aceito | Uma cópia por nó, muitos personagens dentro; `Session` ganha `leave` e o shard não tem extrato nem snapshot. A Cidade era uma sessão por personagem, e ninguém via ninguém — o que fazia o critério da FUN-33 passar por vacuidade. |
