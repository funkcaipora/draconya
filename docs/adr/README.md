...
| [0021](0021-coolify-same-origin-deployment.md) | Deploy integrado no Coolify | aceito | Cliente, API e WebSocket na mesma origem HTTPS; banco e Redis internos, com migrações antes do boot. |
