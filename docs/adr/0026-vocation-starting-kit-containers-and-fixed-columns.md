...
**Status:** aceito — decisões 3 (munição por família), 4 (skill `melee` única) e 8 (runa como supply de gold) substituídas pelo [ADR 0032](0032-the-rendered-hud-is-the-game-contract.md); decisão 5 (Exura Sio excluída) emendada pelo [ADR 0035](0035-party-v2-runtime-settings-shared-bag-and-live-join.md)
**Data:** 2026-09-12
