...
**Status:** aceito — decisão 5 emendada por #359 (custo e loot como dois eixos independentes) e pelo [ADR 0033](0033-party-v2-runtime-settings-shared-bag-and-live-join.md); decisões 8 e 9 emendadas pelo [ADR 0033](0033-party-v2-runtime-settings-shared-bag-and-live-join.md)
**Data:** 2026-09-15
