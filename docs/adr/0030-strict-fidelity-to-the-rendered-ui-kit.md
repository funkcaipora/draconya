...
**Status:** aceito — decisões 2, 4, 5, 6 e 7 emendadas pelo [ADR 0032](0032-the-rendered-hud-is-the-game-contract.md) (a imagem decide: disparo manual entra, postura funciona, nada fica omitido sem issue, bolsa com moeda física, P1/P4 confirmadas); emendado pelo [ADR 0033](0033-action-catalogue-carries-display-numbers.md) (régua do `ActionConfigModal`)
**Data:** 2026-09-16
