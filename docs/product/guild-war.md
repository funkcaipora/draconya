...
| Penalidade de XP ao time derrotado (Free / Premium) | 60% / 54% da XP do level atual, piso level 8 (mesma regra de `death.md`, §26.2) | caminho previsto: `packages/content/guildwar` |
...
Todos os itens acima bloqueiam o épico E12 (`docs/technical-architecture.md` §20).
