...
import {
  ...
  botExitRuleSchema, botLureSchema, botRingSwapSchema, botRuleSchema, botTargetingSchema,
} from './schemas.js';
...
const content = buildContent({
  ...
  supplies: [
    ...
    {
      id: 'mana-potion-friend', name: 'Poção de Mana em Amigo', price: 50,
...
describe('follow de membro e alvo de regra (§24-30, ADR 0033 d.9 e d.10)', () => {
