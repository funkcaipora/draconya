...
- **Um passo por vez, por personagem, no relógio do PROCESSO** (`#walkingUntil` em
  ...
  silêncio — o teclado do cliente repete no ritmo do passo, e o ritmo é daqui. Teste que dá
  muitos passos em sequência precisa de um `now` que ande (a praça da FUN-33 avança o relógio
  a cada consulta).
