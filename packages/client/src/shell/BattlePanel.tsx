...
// no mesmo `HEALTH_POLL_MS` de 1 s. `targetId` trafega via `player-stats`/`session-state` (#341,
// SV-05) e a criatura correspondente ganha a moldura `.battle-row-selected` (#348, SV-12).
//
