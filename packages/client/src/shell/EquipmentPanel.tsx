...
//
// **O slot `ammo` é genérico desde a AB-05 (#420).** A munição é item empilhável no slot
// (ADR 0032 decisão 7): ele desenha a pilha equipada e a contagem, como qualquer slot, e o
// seletor por família sobre o Escudo (`AmmoPicker`) não existe mais.
//
