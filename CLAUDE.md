...
- **Sempre existe um `CLAUDE.md` dentro do pacote que você está editando.** Leia antes de mudar
...
- **Decisão de arquitetura vira ADR.** Se ela muda um dos onze invariantes acima, este arquivo é
  atualizado no mesmo commit — senão o norte descrito aqui e o código divergem.
