...
| Conteúdo, cliente e ferramentas | Carregador versionado, formato de tilemap e rota, validador de CLI, store de estado fora do React, viewport Pixi com câmera e interpolação, e a casca com ciclo de conexão e reanexação (FUN-8/9/22/23/24) | Assets do cliente Tibia e as janelas da Fase 2 |
